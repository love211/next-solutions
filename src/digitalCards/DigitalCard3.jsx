...
import { getCardData } from "@/util/cardHelper";

const DigitalCard3 = ({ data, isPreview = false }) => {
        ...
        >
          ...
          <div className="w-full h-fit px-[4.188rem] flex flex-col gap-[0.88rem]">
            <div className="w-full flex flex-col gap-[0.5rem] text-center text-white">
              <p className="font-serif text-[1.875rem] font-bold">{name}</p>
              <p className="text-2xl text-[#F0EBE5]">{designation}</p>
            </div>
          ...
          <div className="w-full md:px-[4.188rem] px-[1rem] flex flex-col gap-[0.88rem] text-white">
            <button className="w-full h-[2.937rem] flex items-center justify-center gap-[0.88rem] rounded-[1.125rem] bg-[rgba(198,66,95,0.58)]">
              <BsTelephone className="fill-white" /> <p>{phone}</p>
            </button>
            <button className="w-full h-[2.937rem] flex items-center justify-center gap-[0.88rem] rounded-[1.125rem] bg-[rgba(198,66,95,0.58)]">
          ...
          <div className="w-full md:px-[2.288rem] px-[1rem] flex flex-col items-center gap-[1.25rem]">
