...
const TemplateGenerationLayout = () => {
  ...
  return (
    <div className="w-screen flex">
      ...
      <div className="lg:basis-[55%] w-full flex flex-col items-center gap-[1rem] lg:px-4 justify-between border-r-2 py-2">
        ...
        <div className="w-full h-fit px-2 py-2 flex-col flex lg:hidden bg-white">
          <div className="w-full flex py-2  items-center justify-between ">
            <p className="text-[#3d3c3c] text-2xl text-bold shadow-sm italic">
              Next Solution
            </p>
        ...
        <div className="w-full px-5 flex flex-col gap-[1rem]">
          ...
          <div className="w-full h-[12rem] px-6 py-6 flex items-center gap-[1rem] bg-[#264f1a] rounded-[1.5rem]">
            ...
            <div className="min-w-fit h-full hidden xl:flex">
      ...
      <div className="lg:basis-[35%] w-full h-fit py-6 lg:flex flex-col items-center justify-center sticky top-2 hidden">
