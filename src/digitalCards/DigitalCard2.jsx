...
const DigitalCard2 = () => {
  return (
    <div className="flex justify-center items-center h-screen text-white text-center border-[#545454]">
      <div className="mock-up-2 gap-28   overflow-hidden text-center  border-[#545454]   rounded-[1.25rem] flex flex-col justify-center items-center outline outline-[5px] outline-black ">
        <div className="h-[25rem] flex flex-col justify-end pb-8">
          <img
