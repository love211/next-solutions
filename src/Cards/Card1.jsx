...
const Card1 = () => {
  return (
    <div className="max-w-sm my-8 p-6 bg-[#132A13] rounded-lg shadow-lg ">
  ...
  <path d="M19.5 10.25C19.5 12.7033 18.5254 15.056 16.7907 16.7907C15.056 18.5254 12.7033 19.5 10.25 19.5C7.79675 19.5 5.44397 18.5254 3.70926 16.7907C1.97455 15.056 1 12.7033 1 10.25M19.5 10.25C19.5 7.79675 18.5254 5.44397 16.7907 3.70926C15.056 1.97455 12.7033 1 10.25 1C7.79675 1 5.44397 1.97455 3.70926 3.70926C1.97455 5.44397 1 7.79675 1 10.25M19.5 10.25H1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M13.8073 10.25C13.6325 13.6326 12.3866 16.8721 10.2496 19.5C8.11258 16.8721 6.86665 13.6326 6.69189 10.25C6.86665 6.86736 8.11258 3.62793 10.2496 1C12.3866 3.62793 13.6325 6.86736 13.8073 10.25Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
            </div>
  ...
  <path d="M5.25 7.5L12 12.75L18.75 7.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <p className="text-gray-400">helen@nextsolution.com</p>
          </div>
        </div>
      </div>
    </div>
